...
function loadDataTable() {
    dataTable = $('#DT_load').DataTable({
        "ajax": {
            "url": "/DestaquesPrincipais/GetAll/",
            "type": "GET",
            "datatype": "json"
        },
        "columns": [
            ...
            { "data": "ativo", "width": "20%" },
            {
                ...
                "render": function (data) {
                    return `<div class="text-center">
                        <a href="/DestaquesPrincipais/Upsert?id=${data}" class='btn btn-success text-white' style='cursor:pointer; width:70px;'>
                            Editar
                        </a>
                        &nbsp;
                        <a class='btn btn-danger text-white' style='cursor:pointer; width:70px;'
                            onclick=Deletar('/DestaquesPrincipais/Delete?id='+${data})>
                            Deletar
                        </a>
                        </div>`;
                }, "width": "20%"
